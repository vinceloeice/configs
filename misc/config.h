/* See LICENSE file for copyright and littcense details. */
...
static const char *clipmenud[] = { "clipmenud", NULL};
...
//	{ MODKEY,         		          XK_w,      spawn,		       SHCMD("MOZ_X11_EGL=1 firefox") }, //VA-API
